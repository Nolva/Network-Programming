...
CString m_strPOP3_ser = _T("pop.163.com");
CString	m_strPOP3_port = _T("110");
CString	m_strSMTP_ser = _T("smtp.163.com");
CString	m_strSMTP_port = _T("25");
CString	m_strUser_name = _T("cloud_int@163.com");
CString	m_strUser_pass = _T("1q2w3e");
char key[256] = "abcde";
//bitset<64> key;                // 64位密钥
